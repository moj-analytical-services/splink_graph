...
import json
from splink_graph.edge_metrics import (
    edgebetweeness,
    bridge_edges
)
...
def test_edgebetweeness_simple_customcolname2(spark):
    ...
    df_result = edgebetweeness(e_df, src="id_l", dst="id_r",cluster_id_col="estimated_id").toPandas()
...
def test_bridges_customcolname(spark):
    ...
    assert bridge_edges(e2_df,src="id_l",dst="id_r",cluster_id_col="estimated_group").toPandas()["id_l"].count()==6
